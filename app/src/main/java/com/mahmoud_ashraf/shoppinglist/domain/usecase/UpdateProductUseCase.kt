 ...
 */
class UpdateProductUseCase @Inject constructor(private val shoppingListRepository: ShoppingListRepository) {
    suspend operator fun invoke(productEntity: ProductEntity) = shoppingListRepository.updateProduct(productEntity)
}